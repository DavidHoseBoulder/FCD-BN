...
async function getSheetsClient() {
  ...
  if (!credentialsJsonString) {
    ...
    // This log helps confirm if we're running locally vs deployed.
    if (process.env.NODE_ENV === 'development') {
       console.log('GOOGLE_APPLICATION_CREDENTIALS_JSON found. Running in local development mode.');
    } else {
       console.log('GOOGLE_APPLICATION_CREDENTIALS_JSON found. Running in deployed production mode.');
    }
  }
